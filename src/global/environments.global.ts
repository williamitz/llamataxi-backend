...
export const ENCRYPT_KEY = process.env.ENCRYPT_KEY || 'Ll4m4t4x1-2020';

export const HOST_DB = process.env.HOST_DB || '192.168.1.40'; // 'localhost'; // "206.189.182.84"; // 
export const PORT_DB = parseInt(process.env.PORT_DB || '3306'); 
export const USER_DB = process.env.USER_DB || 'laptop' // 'root'; // 'llamataxi' // 
export const PASSWORD_DB = process.env.PASSWORD_DB || '123456'; // ''; // "p&DEw4oYjK#V"; // 
