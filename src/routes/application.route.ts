...
ApplicationRouter.post(
  ...
  (req: any, res: Response) => {
    ...
    let sql = `CALL as_sp_addApplication( '${body.nameApp}', '${
      body.description
    }', '${body.plattform}',  ${fkUser}, '${reqIp.getClientIp(req)}' );`;
...
ApplicationRouter.put(
  ...
  (req: any, res: Response) => {
    ...
    let sql = `CALL as_sp_updateApplication( ${pkParam}, '${body.nameApp}', '${
      body.description
    }', '${body.plattform}',  ${fkUser} , '${reqIp.getClientIp(req)}' );`;
...
ApplicationRouter.delete(
  "/Application/Delete/:id/:statusRegister",
  [verifyToken, verifyWebmasterRole],
  (req: any, res: Response) => {
    ...
    let sql = `CALL as_sp_deleteApplication( '${pkApp}', ${status}, ${fkUser} , '${reqIp.getClientIp(
      req
    )}' );`;
