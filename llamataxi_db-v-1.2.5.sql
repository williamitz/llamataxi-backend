...
CREATE TABLE `as_bank`  (
  `pkBank` tinyint(255) NOT NULL AUTO_INCREMENT,
  `bankName` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `bankAlias` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  PRIMARY KEY (`pkBank`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for aw_awars
-- ----------------------------
DROP TABLE IF EXISTS `aw_awars`;
CREATE TABLE `aw_awars`  (
  `pkAward` int(255) NOT NULL AUTO_INCREMENT,
  `nameAward` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  ...
  `sku` char(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  ...
  PRIMARY KEY (`pkAward`) USING BTREE
...
CREATE TABLE `rb_config_referal`  (
  ...
  `bonusCliRef` float(4, 2) NULL DEFAULT 0.00,
  `amountDriver` float(4, 2) NOT NULL,
  `bonusDriRef` float(4, 2) NULL DEFAULT 0.00,
...
CREATE TABLE `rb_referal_user`  (
  ...
  `bonusUsed` float(5, 2) NULL DEFAULT 0.00,
  `dateExpiration` date NULL DEFAULT NULL,
  `dateUsed` datetime(0) NULL DEFAULT NULL,
  `isUsed` tinyint(255) NULL DEFAULT 0,
  `bonusType` char(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT 'REFERA',
  `fkUserRefered` int(255) NULL DEFAULT NULL,
  `nameRefered` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
-- Table structure for ts_account_driver
-- ----------------------------
DROP TABLE IF EXISTS `ts_account_driver`;
CREATE TABLE `ts_account_driver`  (
  `pkAccountDriver` int(255) NOT NULL AUTO_INCREMENT,
  `fkDriver` int(255) NULL DEFAULT NULL,
  `ccAccount` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `cciAccount` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `fkBank` tinyint(255) NULL DEFAULT NULL,
  `bankName` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `bankAlias` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `statusRegister` tinyint(1) NULL DEFAULT NULL,
  `fkUserRegister` int(255) NULL DEFAULT NULL,
  `dateRegister` datetime(0) NULL DEFAULT NULL,
  `ipRegister` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `fkUserUpdate` int(11) NULL DEFAULT NULL,
  `dateUpdate` datetime(0) NULL DEFAULT NULL,
  `ipUpdate` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `fkUserDelete` int(255) NULL DEFAULT NULL,
  `dateDelete` datetime(0) NULL DEFAULT NULL,
  `ipDelete` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  PRIMARY KEY (`pkAccountDriver`) USING BTREE
...
CREATE TABLE `ts_journal_driver`  (
  ...
  `totalCash` float(10, 2) NULL DEFAULT 0.00,
  `totalCard` float(10, 2) NULL DEFAULT 0.00,
  `totalCredit` float(10, 2) NULL DEFAULT 0.00,
  `totalDiscount` float(10, 2) NULL DEFAULT 0.00,
...
-- ----------------------------
-- Table structure for ts_liquidation
-- ----------------------------
DROP TABLE IF EXISTS `ts_liquidation`;
CREATE TABLE `ts_liquidation`  (
  `pkLiquidation` bigint(255) NOT NULL AUTO_INCREMENT,
  `operation` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `observation` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `fileOperation` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `amount` float(5, 2) NOT NULL,
  `amountCompany` float(5, 2) NULL DEFAULT NULL,
  `haveDebt` tinyint(1) NULL DEFAULT NULL,
  `fkAccountDriver` int(255) NOT NULL,
  `statusRegister` tinyint(1) NOT NULL,
  `fkUserRegister` int(255) NOT NULL,
  `dateRegister` datetime(0) NOT NULL,
  `ipRegister` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `fkUserUpdate` int(11) NULL DEFAULT NULL,
  `dateUpdate` datetime(0) NULL DEFAULT NULL,
  `ipUpdate` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `fkUserDelete` int(255) NULL DEFAULT NULL,
  `dateDelete` datetime(0) NULL DEFAULT NULL,
  `ipDelete` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`pkLiquidation`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Function structure for as_fn_add_bonusReferal
-- ----------------------------
DROP FUNCTION IF EXISTS `as_fn_add_bonusReferal`;
delimiter ;;
CREATE FUNCTION `as_fn_add_bonusReferal`(`InCodeReferal` varchar(15),
`InFkUserReferred` INT, # fk user del usuario referido( singin )
`InRoleReferred` varchar(15),
`InName` varchar(40))
 RETURNS bigint(20)
BEGIN
	#Routine body goes here...
	DECLARE outPkReferalUser BIGINT DEFAULT 0;
	DECLARE vPkUserReferal INT DEFAULT 0;
	DECLARE vRoleReferal VARCHAR(15) DEFAULT '';
	
	DECLARE vAmountCli, vAmountDri,vBonusCli, vBonusDri FLOAT(5,2) DEFAULT 0;
	DECLARE vExpCli, vExpDriver TINYINT DEFAULT 0;

				#	f. exp referente # f. exp referido
	DECLARE vDateExpReferal, vDateExpReferred date DEFAULT CURRENT_DATE();
	DECLARE vAmountReferal, vAmountReferred FLOAT(5,2) DEFAULT 0;
	
	SELECT pkUser, role
	INTO vPkUserReferal, vRoleReferal
	FROM as_user
	WHERE codeReferal = InCodeReferal
	LIMIT 0,1;
	
	SELECT amountClient, amountDriver, bonusCliRef, bonusDriRef, daysExpClient, daysExpDriver
	INTO vAmountCli, vAmountDri,vBonusCli, vBonusDri, vExpCli, vExpDriver
	FROM rb_config_referal
	LIMIT 0,1;

	
	CASE vRoleReferal
		WHEN 'CLIENT_ROLE' THEN
			
			# Si el referente es cliente
			SET vDateExpReferal = DATE_ADD(CURRENT_DATE(),INTERVAL vExpCli DAY);
			SET vAmountReferal = vAmountCli;
					
		ELSE
			
			SET vDateExpReferal = DATE_ADD(CURRENT_DATE(),INTERVAL vExpDriver DAY);
			SET vAmountReferal = vAmountDri;
	...
	CASE InRoleReferred
		WHEN 'CLIENT_ROLE' THEN
			...
			# Si el referente es cliente
			SET vDateExpReferred = DATE_ADD(CURRENT_DATE(),INTERVAL vExpCli DAY);
			SET vAmountReferred = vBonusCli;
					
		ELSE
			
			SET vDateExpReferred = DATE_ADD(CURRENT_DATE(),INTERVAL vExpDriver DAY);
			SET vAmountReferred = vBonusDri;

	END CASE;
	
	#agregamos el registro al referente
	
	IF vPkUserReferal != 0 THEN
		
		INSERT INTO rb_referal_user ( fkUser,
																bonus,
																dateExpiration,
																bonusType,
																fkUserRefered,
																nameRefered,
																	dateRegister)
		VALUES( vPkUserReferal,
						vAmountReferal,
						vDateExpReferal,
						'REFERA',
						InFkUserReferred,
						CONCAT(InName,', ha asociado tu código'),
						CURRENT_TIMESTAMP() );
		
		SET outPkReferalUser = LAST_INSERT_ID();
		
		#agregamos bonus al referido
		...
		INSERT INTO rb_referal_user ( fkUser,
																	...
																	nameRefered,
																	dateRegister)
		VALUES( InFkUserReferred,
						vAmountReferred,
						vDateExpReferred,
						'REFERA',
						-- InFkUserReferred,
						CONCAT('Bono de bienvenida'),
						CURRENT_TIMESTAMP() );
...
-- ----------------------------
-- Function structure for as_fn_generateCode
-- ----------------------------
DROP FUNCTION IF EXISTS `as_fn_generateCode`;
delimiter ;;
CREATE FUNCTION `as_fn_generateCode`(`InName` varchar(40),
...
-- ----------------------------
-- Function structure for as_fn_verify_accountClient
-- ----------------------------
DROP FUNCTION IF EXISTS `as_fn_verify_accountClient`;
delimiter ;;
CREATE FUNCTION `as_fn_verify_accountClient`(`InPkUser` int,
`InCode` char(4))
 RETURNS tinyint(4)
BEGIN
	#Routine body goes here...
	DECLARE outError, vErrCode, vErrStatus, vErrExp, vErrFound TINYINT DEFAULT 0;
	DECLARE vPkUser INT;
	
	SELECT pkUser,
				IF( statusRegister = 0 , 2, 0),
				IF( codeVerifyExp < CURRENT_TIMESTAMP() , 8, 0),
				IF( codeVerify != InCode ,16, 0)
	INTO vPkUser, vErrStatus, vErrExp, vErrCode
	FROM as_user
	WHERE pkUser = InPkUser;
	...
	SET outError = outError + vErrFound + vErrCode + vErrStatus + vErrExp;
...
-- ----------------------------
-- Function structure for as_fn_verify_addClient
-- ----------------------------
DROP FUNCTION IF EXISTS `as_fn_verify_addClient`;
delimiter ;;
CREATE FUNCTION `as_fn_verify_addClient`(`InFkTypeDocument` int,
`InFkNationality` int,
...
BEGIN
	...
	DECLARE outError, vErrFound,vErrNumber, vErrStatus, vErrFoundDriver, vErrLimit TINYINT DEFAULT 0;
	...
	SELECT IF( COUNT(*) > 2, 8, 0) INTO vErrLimit
	FROM as_vehicle
	WHERE fkDriver = InFkDriver AND statusRegister = 1;

	
	SET outError = outError + vErrNumber + vErrFoundDriver + vErrStatus + vErrLimit;
...
-- ----------------------------
-- Function structure for as_fn_verify_BonusReferal
-- ----------------------------
DROP FUNCTION IF EXISTS `as_fn_verify_BonusReferal`;
delimiter ;;
CREATE FUNCTION `as_fn_verify_BonusReferal`(`InCodeReferal` varchar(15))
 RETURNS tinyint(4)
BEGIN
	#Routine body goes here...
	DECLARE outError, vErrStatus, vErrVerif TINYINT DEFAULT 0;
	DECLARE vPkUser INT;
	...
	SELECT pkUser,
					IF(statusRegister = 0, 2, 0),
					IF( verified = 0 , 4, 0)
	INTO vPkUser, vErrStatus, vErrVerif
	FROM as_user
	WHERE codeReferal = InCodeReferal
	LIMIT 0,1;
	...
	SET outError = outError + vErrStatus + vErrVerif;
...
-- ----------------------------
-- Function structure for as_fn_verify_confirmPhone
-- ----------------------------
DROP FUNCTION IF EXISTS `as_fn_verify_confirmPhone`;
delimiter ;;
CREATE FUNCTION `as_fn_verify_confirmPhone`(`InPkUser` int,
`InPkPerson` int)
 RETURNS tinyint(4)
BEGIN
	#Routine body goes here...
	...
	SET outError = outError + vErrFound + vErrStatus;
...
-- ----------------------------
-- Function structure for as_fn_verify_loginClient
-- ----------------------------
DROP FUNCTION IF EXISTS `as_fn_verify_loginClient`;
delimiter ;;
CREATE FUNCTION `as_fn_verify_loginClient`(`InUserName` varchar(40))
 RETURNS tinyint(4)
BEGIN
	#Routine body goes here...
	DECLARE vPkUser INT;
	DECLARE outError, vErrPass, vErrFound, vErrVerified, vErrStatus, vErrRole TINYINT DEFAULT 0 ;
	...
	INTO vPkUser, vErrVerified, vErrStatus, vErrRole
	FROM as_user 
...
-- ----------------------------
-- Function structure for as_fn_verify_resendCode
-- ----------------------------
DROP FUNCTION IF EXISTS `as_fn_verify_resendCode`;
delimiter ;;
CREATE FUNCTION `as_fn_verify_resendCode`(`InPkUser` int,
`InPkPerson` int)
 RETURNS tinyint(4)
BEGIN
	#Routine body goes here...
	DECLARE outError, vErrFound, vErrStatus, vErrExp TINYINT DEFAULT 0;
	DECLARE vPkUser INT;
	
	SELECT pkUser,
					IF( statusRegister IS NULL , 2, 0),
					IF( codeVerifyExp > CURRENT_TIMESTAMP() , 4, 0)
	INTO vPkUser, vErrStatus, vErrExp
	FROM as_user
	WHERE pkUser = InPkUser AND fkPerson = InPkPerson;
	...
	SET outError = outError + vErrFound + vErrStatus + vErrExp;
...
-- ----------------------------
-- Function structure for as_fn_verify_updateProfileWeb
-- ----------------------------
DROP FUNCTION IF EXISTS `as_fn_verify_updateProfileWeb`;
delimiter ;;
CREATE FUNCTION `as_fn_verify_updateProfileWeb`(`InPkUser` int,
`InEmail` varchar(100))
 RETURNS tinyint(4)
BEGIN
	#Routine body goes here...
	DECLARE outError, vErrFound, vErrStatus, vErrEmail TINYINT DEFAULT 0;
	DECLARE vPkUser INT;
	...
	SELECT IF( P.email = TRIM( InEmail ), 4, 0) INTO vErrEmail
	FROM as_user U
	LEFT JOIN as_person P ON P.pkPerson = U.fkPerson
	WHERE U.pkUser != InPkUser AND P.email = TRIM( InEmail );
	...
	SET outError = vErrFound + vErrStatus + vErrEmail;
...
-- ----------------------------
-- Procedure structure for as_sp_addClient
-- ----------------------------
DROP PROCEDURE IF EXISTS `as_sp_addClient`;
delimiter ;;
CREATE PROCEDURE `as_sp_addClient`(IN `InFkTypeDocument` INT, 
...
IN `InPrefixPhone` VARCHAR(20),
IN `InPhone` VARCHAR(20), 
IN `InUser` VARCHAR(60), 
IN `InPassword` VARCHAR(200),
IN `InConditions` tinyint,

IN `InCodeVerify` char(4),
IN `InCodeVerifExp` datetime,

IN `InCodeReferal` varchar(15),

IN `InIpUser` VARCHAR(20))
BEGIN
	#Routine body goes here...
	DECLARE outError, outErrorRef, outPkUser, outPkPerson, outNewAccounts INT DEFAULT 0;
	DECLARE outPkLog, outPkReferal BIGINT DEFAULT 0;
	DECLARE outCodeReferal VARCHAR(20) DEFAULT '';
	
	-- SET outErrorRef = as_fn_verify_BonusReferal( InCodeReferal );
	
	SET outError = as_fn_verify_addClient(InFkTypeDocument, InFkNationality, InDocument, InEmail, InUser, 'CLIENT_ROLE');
	...
	IF outError = 0 THEN
		...
		INSERT INTO as_user(
			...
			InCodeVerify,
			InCodeVerifExp,
			0, # cuenta pendiente de verificación
			0,
			CURRENT_TIMESTAMP(),
			InIpUser,
			InCodeReferal
		...
		#agregar bonus a referido si lo encuentra
		# InCodeReferal
		
		/*IF outErrorRef = 0 THEN
			
			# añadimos el bonus al referente
			SET outPkReferal = as_fn_add_bonusReferal(InCodeReferal, outPkUser, 'CLIENT_ROLE', InName );
			
		END IF;*/

		
		
		# generar código referente
		
		SET outCodeReferal = as_fn_generateCode( InName, InSurname, outPkUser );
					
		UPDATE as_user SET codeReferal = outCodeReferal
	...
	SELECT outError AS 'showError',
				...
				InPhone AS 'phone',
				InEmail AS 'email',
				InFkNationality AS 'fkNationality',
				InPrefixPhone AS 'prefixPhone',
				outCodeReferal AS 'codeReferal',
...
BEGIN
	...
	DECLARE outError, outErrorRef, outPkUser, outPkPerson, outPkDriver, outPkVehicle, outNewAccounts INT DEFAULT 0;
	DECLARE outPkLog, outPkReferal BIGINT DEFAULT 0;
	...
	IF outError = 0 THEN
		...
		/*IF outErrorRef = 0 THEN
			...
			# añadimos el bonus al referente
			SET outPkReferal = as_fn_add_bonusReferal(InCodeReferal, outPkUser, 'DRIVER_ROLE', InName );
			
		END IF;*/

					
		UPDATE as_user SET codeReferal = as_fn_generateCode( InName, InSurname, outPkUser )
		WHERE pkUser = outPkUser;
...
-- ----------------------------
-- Procedure structure for as_sp_confirmPhone
-- ----------------------------
DROP PROCEDURE IF EXISTS `as_sp_confirmPhone`;
delimiter ;;
CREATE PROCEDURE `as_sp_confirmPhone`(IN `InPkUser` int,
IN `InPkPerson` int,
IN `InFkNationality` int,
IN `InPhone` varchar(15),

IN `InCodeVerif` varchar(15),
IN `InExpVerif` datetime)
BEGIN
	#Routine body goes here...
	DECLARE outError TINYINT DEFAULT 0;
	
	SET outError = as_fn_verify_confirmPhone( InPkUser, InPkPerson );
	
	IF outError = 0 THEN
		
		UPDATE as_person SET phone = InPhone,
													fkNationality = InFkNationality
		WHERE pkPerson = InPkPerson;
		
		UPDATE as_user SET 	codeVerify = InCodeVerif,
												codeVerifyExp = InExpVerif
		WHERE pkUser = InPkUser AND fkPerson = InPkPerson;
...
-- ----------------------------
-- Procedure structure for as_sp_getConfigSystem
-- ----------------------------
DROP PROCEDURE IF EXISTS `as_sp_getConfigSystem`;
delimiter ;;
CREATE PROCEDURE `as_sp_getConfigSystem`()
BEGIN
	#Routine body goes here...

	SELECT 	cc_config.pkConfig,
					cc_config.percentRate, 
					cc_config.culquiKey
	FROM cc_config
	LIMIT 0,1;
...
-- ----------------------------
-- Procedure structure for as_sp_getProfileWeb
-- ----------------------------
DROP PROCEDURE IF EXISTS `as_sp_getProfileWeb`;
delimiter ;;
CREATE PROCEDURE `as_sp_getProfileWeb`(IN `InPkUser` int)
BEGIN
	#Routine body goes here...
	
	DECLARE vPkUser INT;
	DECLARE vErrPass, vErrVerified, vErrStatus, vErrRole, vErrFound, outError TINYINT DEFAULT 0 ;
...
BEGIN
	...
	DECLARE outError TINYINT DEFAULT 0;
	DECLARE vPkUser, vPkPerson INT DEFAULT 0;
	DECLARE vUsername, vUserPass, vCodeReferal, vName, vSurname, vNamecom, vPrefix, vCountry, vDocument, vEmail, vPhone, vImg, vRole VARCHAR(100) DEFAULT '';
	

	SET outError = as_fn_verify_loginClient( InUserName );
	...
	-- IF outError = 0 THEN		 
		 ...
		 INTO vPkUser, vPkPerson, vUsername, vUserPass, vCodeReferal, vName, 
					vSurname, vNamecom, vPrefix, vCountry, vDocument, vEmail, vPhone, vImg, vRole
		 FROM as_user U
		 LEFT JOIN as_person P on P.pkPerson = U.fkPerson
		 LEFT JOIN as_type_document TD ON TD.pkTypeDocument = P.fkTypeDocument
		 LEFT JOIN as_nationality N ON N.pkNationality = P.fkNationality
	...
	SELECT outError AS 'showError' ,
					vPkUser AS 'pkUser', vPkPerson AS 'pkPerson',
					vUsername AS 'userName', vUserPass AS 'userPassword', 
					vCodeReferal AS 'codeReferal', vName AS 'name', 
					vSurname AS 'surname', vNamecom AS 'nameComplete', 
					vPrefix AS 'prefixPhone', vCountry AS 'nameCountry', 
					vDocument AS 'document', vEmail AS 'email', 
					vPhone AS 'phone', vImg AS 'img', vRole AS 'role';
...
BEGIN
	...
	SELECT 	pkUser, 
					...
					CASE role
						WHEN 'DRIVER_ROLE' THEN	16
						WHEN 'CLIENT_ROLE' THEN 32
					END 
...
-- ----------------------------
-- Procedure structure for as_sp_refreshMonitor
-- ----------------------------
DROP PROCEDURE IF EXISTS `as_sp_refreshMonitor`;
delimiter ;;
CREATE PROCEDURE `as_sp_refreshMonitor`()
BEGIN
	#Routine body goes here...
	
	UPDATE as_user SET lat = null
	WHERE role = 'DRIVER_ROLE' AND statusSocket = 1;
...
-- ----------------------------
-- Procedure structure for as_sp_resendCode
-- ----------------------------
DROP PROCEDURE IF EXISTS `as_sp_resendCode`;
delimiter ;;
CREATE PROCEDURE `as_sp_resendCode`(IN `InPkUser` int,
IN `InPkPerson` int,
IN `InCodeVerif` varchar(15),
IN `InExpVerif` datetime)
BEGIN
	...
	SET outError = as_fn_verify_resendCode( InPkUser , InPkPerson );
...
BEGIN
	...
	DECLARE outError, vPkPerson INT DEFAULT 0;
	DECLARE outOldImg VARCHAR(100) DEFAULT 'xD.png';
	...
	IF outError = 0 THEN
		...
		SELECT fkPerson,
						IF(img IS NULL, 'xD.png', img)
		INTO vPkPerson, outOldImg
		FROM as_user U
		LEFT JOIN as_person P ON P.pkPerson = U.fkPerson
		WHERE U.pkUser = InPkUser;
...
-- ----------------------------
-- Procedure structure for as_sp_updateProfileWeb
-- ----------------------------
DROP PROCEDURE IF EXISTS `as_sp_updateProfileWeb`;
delimiter ;;
CREATE PROCEDURE `as_sp_updateProfileWeb`(IN `InPkUser` int,
IN `InPkPerson` int,
IN `InName` varchar(40),
IN `InSurname` varchar(40),
...
BEGIN
	...
	SET outError = as_fn_verify_updateProfileWeb( InPkUser, InEmail );
	
	IF outError = 0 THEN
		
		UPDATE as_person SET `name` = InName,
													surname = InSurname,
													nameComplete = CONCAT(InSurname,', ',InName),
													fkTypeDocument = InFkDocument,
													document = InDocument,
													fkNationality = InFkNationality,
													phone = InPhone,
													email = InEmail
...
BEGIN
	...
	DECLARE outError, outErrorRef TINYINT DEFAULT 0;
	DECLARE outPkUser, outPkPerson, outVerified INT DEFAULT 0;
	DECLARE outPkLog, outPkReferal BIGINT DEFAULT 0;
	DECLARE InCodeReferal, InName VARCHAR(40) DEFAULT 'xD';
	
	SELECT U.pkUser, D.fkPerson, U.codeReferalAux, P.`name`
	INTO outPkUser, outPkPerson, InCodeReferal, InName
	FROM as_driver D
	LEFT JOIN as_user U ON U.fkPerson = D.fkPerson
	LEFT JOIN as_person P ON D.fkPerson = P.pkPerson
	WHERE D.pkDriver = InPkDriver;
	...
	SELECT outError AS 'showError', outErrorRef AS 'showErrorRef', outPkLog AS 'pkLog', outVerified AS 'accountsVerified';
...
-- ----------------------------
-- Procedure structure for as_sp_verifyClient
-- ----------------------------
DROP PROCEDURE IF EXISTS `as_sp_verifyClient`;
delimiter ;;
CREATE PROCEDURE `as_sp_verifyClient`(IN `InPkUser` int,
-- IN `InPhone` varchar(15),
-- IN `InfkNationality` int,
IN `InCode` char(4),
IN `InName` varchar(40))
BEGIN
	#Routine body goes here...
	DECLARE outError, outErrorRef TINYINT DEFAULT 0;
	DECLARE InCodeReferal VARCHAR(15) DEFAULT 'xD';
	DECLARE outPkReferal BIGINT DEFAULT 0;
	
	SET outError = as_fn_verify_accountClient( InPkUser, InCode );
	IF outError = 0 THEN
	
		SELECT codeReferalAux INTO InCodeReferal
		FROM as_user
		WHERE pkUser = InPkUser;
		
		UPDATE as_user SET verified = 1,
											 dateVerified = CURRENT_TIMESTAMP(),
											 fkUserVerified = InPkUser
		WHERE pkUser = InPkUser;
		
		IF outErrorRef = 0 THEN
			
			# añadimos el bonus al referente
			SET outPkReferal = as_fn_add_bonusReferal(InCodeReferal, InPkUser, 'CLIENT_ROLE', InName );
	...
	SELECT outError AS 'showError', outErrorRef AS 'showErrorRef';
...
-- ----------------------------
-- Function structure for aw_fn_generateCode
-- ----------------------------
DROP FUNCTION IF EXISTS `aw_fn_generateCode`;
delimiter ;;
CREATE FUNCTION `aw_fn_generateCode`()
 RETURNS char(7) CHARSET utf8mb4
BEGIN
	#Routine body goes here...
	DECLARE outCode CHAR(7);
	DECLARE vCorre VARCHAR(5);
	...
	SET vCorre = CONCAT('000', vTotal );
	
	SET vCorre = SUBSTR( vCorre,  -4 );
	SET outCode = CONCAT('SKU',vCorre);
...
-- ----------------------------
-- Function structure for aw_fn_verify_addAward
-- ----------------------------
DROP FUNCTION IF EXISTS `aw_fn_verify_addAward`;
delimiter ;;
CREATE FUNCTION `aw_fn_verify_addAward`(`InName` varchar(30))
 RETURNS tinyint(4)
BEGIN
	#Routine body goes here...
	DECLARE outError, vErrName, vErrStatus TINYINT DEFAULT 0;
	
	SELECT IF(nameAward = InName, 1, 0),
					IF( statusRegister = 0 , 2, 0)
	INTO vErrName, vErrStatus
	FROM aw_awars
	WHERE nameAward = InName;
...
-- ----------------------------
-- Function structure for aw_fn_verify_deleteAward
-- ----------------------------
DROP FUNCTION IF EXISTS `aw_fn_verify_deleteAward`;
delimiter ;;
CREATE FUNCTION `aw_fn_verify_deleteAward`(`InPkAward` int,
`InStatus` tinyint)
 RETURNS tinyint(4)
BEGIN
	#Routine body goes here...
	...
	DECLARE outError, vErrFound TINYINT DEFAULT 0;
	DECLARE vPkAward INT;
	
	#verificamos existencia de registro
	
	SELECT pkAward INTO vPkAward
	FROM aw_awars
	WHERE pkAward = InPkAward;
	
	IF vPkAward IS NULL THEN
	...
	#verificamos que no existan solicitudes pendientes si se desea desactivar el registro
...
-- ----------------------------
-- Function structure for aw_fn_verify_updateAward
-- ----------------------------
DROP FUNCTION IF EXISTS `aw_fn_verify_updateAward`;
delimiter ;;
CREATE FUNCTION `aw_fn_verify_updateAward`(`InPkAward` int,
`InName` varchar(30))
 RETURNS tinyint(4)
BEGIN
	#Routine body goes here...
	DECLARE outError, vErrName, vErrStatus, vErrFound TINYINT DEFAULT 0;
	DECLARE vPkAward INT;
	...
	INTO vErrName, vErrStatus
	FROM aw_awars
	WHERE nameAward = InName AND pkAward != InPkAward;
	...
	SET outError = vErrName + vErrStatus + vErrFound;
...
-- ----------------------------
-- Procedure structure for aw_sp_addAward
-- ----------------------------
DROP PROCEDURE IF EXISTS `aw_sp_addAward`;
delimiter ;;
CREATE PROCEDURE `aw_sp_addAward`(IN `InName` varchar(30),
IN `InDescription` varchar(100),
IN `InPoints` float(5,2),
IN `InStock` tinyint,
IN `InFkUser` int,
IN `InIpUser` varchar(20))
BEGIN
	...
	SET outError = aw_fn_verify_addAward( InName );
	
	IF outError = 0 THEN
		
		INSERT INTO aw_awars( nameAward,
													description,
													points,
													-- img,
													stock,
	...
	SELECT outError AS 'showError', outPk AS 'pkAward';
...
-- ----------------------------
-- Procedure structure for aw_sp_deleteAward
-- ----------------------------
DROP PROCEDURE IF EXISTS `aw_sp_deleteAward`;
delimiter ;;
CREATE PROCEDURE `aw_sp_deleteAward`(IN `InPkAward` int,
IN `InStatus` tinyint,
IN `InFkUser` int,
IN `InIpUser` varchar(20))
BEGIN
	...
	SET outError = aw_fn_verify_deleteAward( InPkAward, InStatus );
	
	IF outError = 0 THEN
		
		IF InStatus = 0 THEN
			
			UPDATE aw_awars SET statusRegister = 0,
													dateDelete = CURRENT_TIMESTAMP(),
													fkUserDelete = InFkUser,
													ipDelete = InIpUser
			WHERE pkAward = InPkAward;
		...
		ELSE
			...
			UPDATE aw_awars SET statusRegister = 1,
													dateUpdate = CURRENT_TIMESTAMP(),
													fkUserUpdate = InFkUser,
													ipUpdate = InIpUser
			WHERE pkAward = InPkAward;
...
-- ----------------------------
-- Procedure structure for aw_sp_getListAwards
-- ----------------------------
DROP PROCEDURE IF EXISTS `aw_sp_getListAwards`;
delimiter ;;
CREATE PROCEDURE `aw_sp_getListAwards`(IN `InPage` tinyint,
IN `InRowsForPage` tinyint,
IN `InQuery` varchar(40),
IN `InShowInactive` tinyint)
BEGIN
	#Routine body goes here...
	DECLARE outWhere VARCHAR(450) DEFAULT '';
	
	SET @InStart = ( InPage - 1 ) * InRowsForPage;
	SET @InLimit = InRowsForPage;
	
	SET outWhere = CONCAT( ' WHERE statusRegister = ',InShowInactive );
	
	IF InQuery != '' THEN
		SET outWhere = CONCAT( outWhere, "  AND nameAward LIKE '%",InQuery, "%'" );
	END IF;

	
	SET @sql = CONCAT("SELECT pkAward,
														nameAward,
														description,
														points,
														img,
...
-- ----------------------------
-- Procedure structure for aw_sp_overallPageAwards
-- ----------------------------
DROP PROCEDURE IF EXISTS `aw_sp_overallPageAwards`;
delimiter ;;
CREATE PROCEDURE `aw_sp_overallPageAwards`(IN `InQuery` varchar(40),
IN `InShowInactive` tinyint)
BEGIN
	#Routine body goes here...
	DECLARE outWhere VARCHAR(450) DEFAULT '';
...
-- ----------------------------
-- Procedure structure for aw_sp_updateAward
-- ----------------------------
DROP PROCEDURE IF EXISTS `aw_sp_updateAward`;
delimiter ;;
CREATE PROCEDURE `aw_sp_updateAward`(IN `InPkAward` int,
...
BEGIN
	...
	SET outError = aw_fn_verify_updateAward( InPkAward, InName );
	
	IF outError = 0 THEN
		
		UPDATE aw_awars SET   nameAward = InName,
													description = InDescription,
													points = InPoints,
													-- img,
													stock = InStock,
...
-- ----------------------------
-- Procedure structure for aw_sp_updateImgAward
-- ----------------------------
DROP PROCEDURE IF EXISTS `aw_sp_updateImgAward`;
delimiter ;;
CREATE PROCEDURE `aw_sp_updateImgAward`(IN `InPkAward` int,
IN `InImg` varchar(20))
BEGIN
	#Routine body goes here...
	DECLARE outError TINYINT DEFAULT 0;
	...
	SELECT pkAward, IF(img IS NULL , 'xD.png', img)
	INTO vPkAward, outOldImg
	FROM aw_awars
	WHERE pkAward = InPkAward;
...
BEGIN
	#Routine body goes here...
	DECLARE outError, vErrFound, vErrExpired, vErrStatus, vErrRole, vErrRepit, vErrUsed, vErrLimit TINYINT DEFAULT 0;
	...
	ELSE
		...
		SELECT IF(COUNT(*) > 2, 64, 0) INTO vErrLimit
		FROM rb_coupon_user
		WHERE dateExpiration > CURRENT_TIMESTAMP() AND isUsed = 0 AND fkUser = InFkUser;
	...
	SET outError = vErrFound + vErrExpired + vErrRole + vErrStatus + vErrRepit + vErrUsed + vErrLimit;
...
-- ----------------------------
-- Procedure structure for rb_sp_getConfReferal
-- ----------------------------
DROP PROCEDURE IF EXISTS `rb_sp_getConfReferal`;
delimiter ;;
CREATE PROCEDURE `rb_sp_getConfReferal`()
BEGIN
	#Routine body goes here...
	SELECT pkConfigReferal, 
					amountClient,
					bonusCliRef,
					amountDriver,
					bonusDriRef,
...
BEGIN
	...
	DECLARE outWhere, outOrder, outFields VARCHAR(400) DEFAULT '';
	
	SET outWhere = CONCAT( " WHERE CU.statusRegister = 1 AND CU.fkUser = ", InPkUser );
	
	SET outOrder = " ORDER BY CU.dateRegister DESC";
	...
	CASE InStatus
		...
		WHEN 'USED' THEN
			...
			SET outOrder = " ORDER BY CU.dateUsed DESC";
		WHEN 'EXPIRED' THEN
			SET outWhere = CONCAT( outWhere, " AND IF( CU.dateExpiration <= CURRENT_TIMESTAMP() , 1, 0) = 1 " );
			SET outOrder = " ORDER BY CU.dateExpiration DESC";
	END CASE;
...
-- ----------------------------
-- Procedure structure for rb_sp_getReferalUser
-- ----------------------------
DROP PROCEDURE IF EXISTS `rb_sp_getReferalUser`;
delimiter ;;
CREATE PROCEDURE `rb_sp_getReferalUser`(IN `InPage` tinyint,
IN `InStatus` varchar(10),
IN `InFkUser` int)
BEGIN
	#Routine body goes here...
	...
	SET outWhere = CONCAT( " WHERE RF.fkUser = ", InFkUser );
	
	CASE InStatus
		WHEN 'OK' THEN
			SET outWhere = CONCAT( outWhere, " AND RF.isUsed = 0 AND IF( RF.dateExpiration <= CURRENT_DATE() , 1, 0) = 0 " );
		
		WHEN 'USED' THEN
			SET outWhere = CONCAT( outWhere, " AND RF.isUsed = 1 " );
		
		WHEN 'EXPIRED' THEN
			SET outWhere = CONCAT( outWhere, " AND IF( RF.dateExpiration <= CURRENT_DATE() , 1, 0) = 1 " );
	END CASE;
	
	SET outFields =  "  RF.pkReferalUser,
											RF.bonus,
											RF.bonusUsed,
											
											( RF.bonus - RF.bonusUsed ) AS 'bonusVigent',
	...
	SET @sql = CONCAT( "SELECT" 
										...
										-- ," INNER JOIN rb_coupon C ON C.codeCoupon = RF.codeCoupon "
										, outWhere
										, " ORDER BY RF.dateRegister DESC"
										, " LIMIT ?, 5;");
...
-- ----------------------------
-- Procedure structure for rb_sp_getTotalReferal
-- ----------------------------
DROP PROCEDURE IF EXISTS `rb_sp_getTotalReferal`;
delimiter ;;
CREATE PROCEDURE `rb_sp_getTotalReferal`(IN `InFkUser` int)
BEGIN
	#Routine body goes here...
	
	SELECT SUM( RF.bonus ) - SUM( RF.bonusUsed ) AS 'total'
	FROM rb_referal_user RF
	WHERE RF.fkUser = InFkUser AND RF.isUsed = 0 AND IF( RF.dateExpiration <= CURRENT_DATE() , 1, 0) = 0;
...
delimiter ;;
CREATE PROCEDURE `rb_sp_updateConfig`(IN `InAmountClient` float(4,2),
IN `InBonusRefCli` float(4,2),
IN `InAmountDriver` float(4,2),
IN `InBonusRefDri` float(4,2),
...
BEGIN
	...
	UPDATE rb_config_referal SET amountClient = InAmountClient,
															 bonusCliRef = InBonusRefCli,
															 amountDriver = InAmountDriver,
															 bonusDriRef = InBonusRefDri,
...
-- ----------------------------
-- Function structure for ts_fn_count_servicesJournal
-- ----------------------------
DROP FUNCTION IF EXISTS `ts_fn_count_servicesJournal`;
delimiter ;;
CREATE FUNCTION `ts_fn_count_servicesJournal`(`InPkJournal` bigint,
`InFkDriver` int,
`InCodeJournal` varchar(10))
 RETURNS int(11)
BEGIN
	#Routine body goes here...
	DECLARE outTotal INT DEFAULT 0;
	
	SELECT COUNT(*) INTO outTotal
	FROM ts_service S
	INNER JOIN ts_offer_service OF ON S.fkOffer = OF.pkOfferService
	WHERE S.statusService = 3 AND OF.fkJournalDriver = InPkJournal AND OF.fkDriver = InFkDriver;
...
-- ----------------------------
-- Function structure for ts_fn_debt_driverJournal
-- ----------------------------
DROP FUNCTION IF EXISTS `ts_fn_debt_driverJournal`;
delimiter ;;
CREATE FUNCTION `ts_fn_debt_driverJournal`(`InPkJournal` bigint,
`InFkDriver` int)
 RETURNS float
BEGIN
	#Routine body goes here...
	DECLARE outDebt FLOAT(5,2) DEFAULT 0;
	...
	SELECT 
				...
				WHEN 'FORTODAY' THEN
					SUM(rateJournal)
				ELSE
					SUM( rateJournal * countService )
			END
	INTO outDebt
	FROM ts_journal_driver
	WHERE paidOut = 0 AND pkJournalDriver != InPkJournal AND fkDriver = InFkDriver;
	
	IF outDebt IS NULL THEN
...
BEGIN
  ...
  DECLARE vPkReferal BIGINT DEFAULT 0;
	...
	DECLARE vBonusBalance FLOAT(5,2) DEFAULT 0;
	DECLARE vRateBalance FLOAT(5,2) DEFAULT InRate; 
...
-- ----------------------------
-- Function structure for ts_fn_verify_addAccountDriver
-- ----------------------------
DROP FUNCTION IF EXISTS `ts_fn_verify_addAccountDriver`;
delimiter ;;
CREATE FUNCTION `ts_fn_verify_addAccountDriver`(`InFkDriver` int,
`InFkUser` int,
`InAccountCC` varchar(20),
`InAccountCCI` varchar(30))
 RETURNS tinyint(4)
BEGIN
	#Routine body goes here...
	DECLARE outError, vErrFound, vErrCC, vErrCCI, vErrStatus, vErrFoundDriver, vErrLimit TINYINT DEFAULT 0;
	DECLARE vPkDriver INT;
	...
	SELECT	IF( pkAccountDriver IS NULL , 2, 0),
					IF( ccAccount = InAccountCC, 4, 2),
					IF( cciAccount = InAccountCCI, 8, 0),
					IF( statusRegister = 0, 16, 0)
	INTO vErrFound, vErrCC, vErrCCI, vErrStatus
	FROM ts_account_driver
	WHERE fkDriver = InFkDriver AND (ccAccount = InAccountCC OR cciAccount = InAccountCCI )
	LIMIT 0,1;
	
	IF vPkDriver IS NULL THEN
		
		SET vErrFoundDriver = 1;
	...
	SET outError = vErrFoundDriver + vErrFound + vErrCC + vErrCCI + vErrStatus + vErrLimit;
...
BEGIN
	#Routine body goes here...
	DECLARE outError, vErrOpen, vErrVigent, vErrCode ,vErrFound, vErrFoundConf, vErrPendingPai TINYINT DEFAULT 0;

	SELECT IF( journalStatus = 1 ,1, 0),
					IF(  TIMESTAMPDIFF(HOUR, dateStart ,CURRENT_TIMESTAMP()) < 24   , 2, 0)
	
	INTO vErrOpen, vErrVigent
	FROM ts_journal_driver
	WHERE (journalStatus = 1 OR TIMESTAMPDIFF(HOUR, dateStart ,CURRENT_TIMESTAMP()) < 24 )  AND fkDriver = InFkDriver LIMIT 0,1;
	
	SELECT IF(pkJournalDriver IS NOT NULL , 4, 0) INTO vErrCode
	FROM ts_journal_driver
	WHERE fkDriver = InFkDriver AND codeJournal = InCode;
	
	SELECT IF(pkDriver IS NULL ,8 , 0) INTO vErrFound
	FROM as_driver
	WHERE pkDriver = InFkDriver;
	
	SELECT IF(pkConfigJournal IS NULL, 16, 0) INTO vErrFoundConf
	FROM cc_config_journal
	WHERE pkConfigJournal = InFkConfJournal;
	
	SELECT IF( COUNT(*) > 3 ,32, 0) INTO vErrPendingPai
	FROM ts_journal_driver
	WHERE fkDriver = InFkDriver AND paidOut = 0;
	
	SET outError = vErrOpen + vErrVigent + vErrCode + vErrFound + vErrFoundConf + vErrPendingPai;
...
-- ----------------------------
-- Function structure for ts_fn_verify_addLiquidation
-- ----------------------------
DROP FUNCTION IF EXISTS `ts_fn_verify_addLiquidation`;
delimiter ;;
CREATE FUNCTION `ts_fn_verify_addLiquidation`(`InFkJournal` bigint,
 `InFkDriver` int,
 `InOperation` varchar(15),
 `InFkAccount` int)
 RETURNS tinyint(4)
BEGIN
	#Routine body goes here...
	DECLARE outError, vErrFound, vErrStatus, vErrLiquidated, vErrStatusLiq, vErrFoundDriver, vErrFoundAccount, vErrStatusAccount TINYINT DEFAULT 0;
	DECLARE vPkJournal, vPkDriver, vPkAccount INT;
	
	SELECT JD.pkJournalDriver,
					IF( JD.journalStatus = 1 , 1	, 0 ), # error si la jornada está abierta
					IF( LI.statusRegister = 1, 2, 0) # error jornada ya tiene una liquidación
	INTO vPkJournal, vErrStatus, vErrLiquidated
	FROM ts_journal_driver JD
	LEFT JOIN ts_liquidation LI ON LI.pkLiquidation = JD.fkLiquidation
	WHERE JD.pkJournalDriver = InFkJournal AND JD.fkDriver = InFkDriver;
	
	SELECT IF( statusRegister = 1 , 4, 0) INTO  vErrStatusLiq # error si existe una operación con el mismo código activo
	FROM ts_liquidation
	WHERE operation = InOperation LIMIT 0, 1;
	
	SELECT pkDriver INTO vPkDriver
	FROM as_driver
	WHERE pkDriver = InFkDriver;
	
	SELECT pkAccountDriver,
					IF( statusRegister = 0 , 8, 0)
	INTO vPkAccount, vErrStatusAccount
	FROM ts_account_driver
	WHERE fkDriver = InFkDriver AND pkAccountDriver = InFkAccount;
	...
	IF vPkDriver IS NULL THEN
		SET vErrFoundDriver = 32;
	END IF;
	
	IF vPkAccount IS NULL THEN
		SET vErrFoundAccount = 64;
	END IF;
	
	SET outError = vErrStatus + vErrLiquidated + vErrStatusLiq  + vErrStatusAccount + vErrFound + vErrFoundDriver + vErrFoundAccount;
...
BEGIN
	#Routine body goes here...
	DECLARE outError, vInPkDriver, vPkDriver, vPkService, vPkvehicle INT DEFAULT 0;
	...
	SELECT pkService, -- service not found
	...
	INTO vInPkDriver, vErrVerified, vErrStatusDriver
	FROM as_user U
	INNER JOIN as_person P ON P.pkPerson = U.fkPerson
	LEFT JOIN as_driver D ON D.fkPerson = P.pkPerson
	WHERE U.pkUser = InPkDriver;
	...
	IF vPkvehicle IS NULL THEN
		SET vFoundVehicle = 64;
	END IF;
	

	SET outError = vFoundService + vErrService + vErrStatus + vFoundDriver + vErrVerified + vErrStatusDriver + vFoundVehicle + vVerifiedVeh + vErrFoundJournal + vErrStatusJournal + vErrExpired;
...
BEGIN
	#Routine body goes here...
	DECLARE outError, vErrFound, vErrClose, vErrPendingPai TINYINT DEFAULT 0;
	DECLARE vPkJournal INT;
	
	SELECT	pkJournalDriver,
					IF(journalStatus = 0, 2, 0)
	INTO vPkJournal, vErrClose
	FROM ts_journal_driver
	WHERE pkJournalDriver = InPkJournal AND fkDriver = InFkDriver;
	
	/*SELECT IF( COUNT(*) > 3 ,4, 0) INTO vErrPendingPai
	FROM ts_journal_driver
	WHERE fkDriver = InFkDriver AND paidOut = 0;*/
	...
	SET outError = vErrFound + vErrClose + vErrPendingPai;
...
-- ----------------------------
-- Function structure for ts_fn_verify_deleteAccountDriver
-- ----------------------------
DROP FUNCTION IF EXISTS `ts_fn_verify_deleteAccountDriver`;
delimiter ;;
CREATE FUNCTION `ts_fn_verify_deleteAccountDriver`(`InPkAccount` int,
`InFkDriver` int)
 RETURNS tinyint(4)
BEGIN
	#Routine body goes here...
	DECLARE outError, vErrFoundDriver, vErrNotFound TINYINT DEFAULT 0;
	DECLARE vPkDriver, vPkAccount INT;
	
	SELECT pkDriver INTO vPkDriver
	FROM as_driver
	WHERE pkDriver =  InFkDriver;
	
	SELECT pkAccountDriver INTO vPkAccount
	FROM ts_account_driver
	WHERE fkDriver = InFkDriver AND pkAccountDriver = InPkAccount;
	...
	SET outError = vErrFoundDriver + vErrNotFound;
...
-- ----------------------------
-- Function structure for ts_fn_verify_deleteLiquidation
-- ----------------------------
DROP FUNCTION IF EXISTS `ts_fn_verify_deleteLiquidation`;
delimiter ;;
CREATE FUNCTION `ts_fn_verify_deleteLiquidation`(`InPkLiquidation` bigint,
	`InFkJournalDriver` bigint,
	`InFkDriver` int)
 RETURNS int(11)
BEGIN
	#Routine body goes here...
	DECLARE outError, vErrFoundLiq, vErrFoundJou TINYINT DEFAULT 0;
	DECLARE vPkLiqui, vPkJournal INT;

	#verificar que exista la liquidación
	SELECT pkLiquidation INTO vPkLiqui
	FROM ts_liquidation
	WHERE pkLiquidation = InPkLiquidation;
	
	#verificar que exista la jornada
	SELECT pkJournalDriver INTO vPkJournal
	FROM ts_journal_driver			
	WHERE pkJournalDriver = InFkJournalDriver AND fkDriver = InFkDriver;
	
	IF vPkLiqui IS NULL THEN
		SET vErrFoundLiq = 128;
	END IF;
	...
	SET outError = vErrFoundJou + vErrFoundLiq;
...
-- ----------------------------
-- Function structure for ts_fn_verify_updateAccountDriver
-- ----------------------------
DROP FUNCTION IF EXISTS `ts_fn_verify_updateAccountDriver`;
delimiter ;;
CREATE FUNCTION `ts_fn_verify_updateAccountDriver`(`InPkAccount` int,
`InFkDriver` int,
`InFkUser` int,
`InAccountCC` varchar(20),
`InAccountCCI` varchar(30),
`InBankAlias` varchar(20))
 RETURNS tinyint(4)
BEGIN
	#Routine body goes here...
	DECLARE outError, vErrFound, vErrCC, vErrCCI, vErrStatus, vErrFoundDriver, vErrNotFound TINYINT DEFAULT 0;
	DECLARE vPkDriver, vPkAccount INT;
	...
	INTO vErrFound, vErrCC, vErrCCI, vErrStatus
	FROM ts_account_driver
	WHERE fkDriver = InFkDriver AND pkAccountDriver != InPkAccount  AND (ccAccount = InAccountCC OR cciAccount = InAccountCCI )
	LIMIT 0,1;
	...
	SET outError = vErrFoundDriver + vErrFound + vErrCC + vErrCCI + vErrStatus + vErrNotFound;
...
-- ----------------------------
-- Function structure for ts_fn_verify_updateChargeJournal
-- ----------------------------
DROP FUNCTION IF EXISTS `ts_fn_verify_updateChargeJournal`;
delimiter ;;
CREATE FUNCTION `ts_fn_verify_updateChargeJournal`(`InPkJournal` bigint)
 RETURNS tinyint(4)
BEGIN
	#Routine body goes here...
	DECLARE outError TINYINT DEFAULT 0;
	DECLARE vPkJournal	BIGINT ;
	
	SELECT pkJournalDriver INTO vPkJournal
	FROM ts_journal_driver
	WHERE pkJournalDriver = InPkJournal;
...
-- ----------------------------
-- Function structure for ts_fn_verify_updateLiquidation
-- ----------------------------
DROP FUNCTION IF EXISTS `ts_fn_verify_updateLiquidation`;
delimiter ;;
CREATE FUNCTION `ts_fn_verify_updateLiquidation`(`InPkLiquidation` bigint,
 `InFkJournal` bigint,
 `InFkDriver` int,
 `InOperation` varchar(15),
 `InFkAccount` int)
...
BEGIN
	#Routine body goes here...
	DECLARE outError, vErrFound, vErrStatus, vErrStatusLiq, vErrFoundDriver, vErrFoundAccount, vErrFoundLiqu, vErrStatusAccount INT DEFAULT 0;
	DECLARE vPkJournal, vPkDriver, vPkLiqui, vPkAccount INT;
	
	SELECT JD.pkJournalDriver,
					IF( JD.journalStatus = 1 , 1	, 0 ) # error si la jornada está abierta
	INTO vPkJournal, vErrStatus
	FROM ts_journal_driver JD
	WHERE JD.pkJournalDriver = InFkJournal AND JD.fkDriver = InFkDriver;
	
	SELECT IF( statusRegister = 1 , 4, 0) INTO  vErrStatusLiq # error si existe una operación con el mismo código activo
	FROM ts_liquidation
	WHERE operation = InOperation AND pkLiquidation != InPkLiquidation LIMIT 0, 1;
	...
	IF vPkLiqui IS NULL THEN
		SET vErrFoundLiqu = 128;
	END IF;
	
	SET outError = vErrStatus + vErrStatusLiq  + vErrStatusAccount + vErrFound + vErrFoundDriver + vErrFoundAccount + vErrFoundLiqu;
...
-- ----------------------------
-- Procedure structure for ts_sp_addAccountDriver
-- ----------------------------
DROP PROCEDURE IF EXISTS `ts_sp_addAccountDriver`;
delimiter ;;
CREATE PROCEDURE `ts_sp_addAccountDriver`(IN `InAccountCC` varchar(20),
IN `InAccountCCI` varchar(30),
IN `InFkBank` tinyint,
-- IN `InNameBank` varchar(40),
-- IN `InAliasBank` varchar(20),
IN `InFkDriver` int,
IN `InFkUser` int,
IN `InIpUser` varchar(20))
BEGIN
	#Routine body goes here...
	DECLARE outError TINYINT DEFAULT 0;
	DECLARE outPkAccount INT DEFAULT 0;
	
	SET outError = ts_fn_verify_addAccountDriver( InFkDriver, InFkUser, InAccountCC, InAccountCCI );
	
	IF outError = 0 THEN
		
		INSERT INTO ts_account_driver( fkDriver,
																	ccAccount,
																	cciAccount,
																	fkBank,
																	-- bankName,
		...
		SET outPkAccount = LAST_INSERT_ID();
	
	ELSE
		
		SELECT pkAccountDriver INTO outPkAccount
		FROM ts_account_driver
		WHERE fkDriver = InFkDriver AND (ccAccount = InAccountCC OR cciAccount = InAccountCCI )
		LIMIT 0,1;
	...
	SELECT outError AS 'showError', outPkAccount AS 'pkAccount';
...
IN `InCardCulqui` varchar(30),
IN `InChargeAmount` int,
...
BEGIN
	...
	DECLARE outPkJournal, outAuxJournal INT DEFAULT 0;
	...
	INTO outAuxJournal
	FROM ts_journal_driver
	WHERE IF( dateEnd <= CURRENT_TIMESTAMP() , 1, 0) = 1 AND fkDriver = InFkDriver LIMIT 0,1; 
	
	SELECT outError AS 'showError', outPkJournal AS 'pkJournal', outCode AS 'codeJournal', vDateStart AS 'dateStart', outAuxJournal AS 'pkJournalAux';
...
-- ----------------------------
-- Procedure structure for ts_sp_addLiquidation
-- ----------------------------
DROP PROCEDURE IF EXISTS `ts_sp_addLiquidation`;
delimiter ;;
CREATE PROCEDURE `ts_sp_addLiquidation`(IN `InFkJournalDriver` bigint,
IN `InFkDriver` int,
...
BEGIN
	#Routine body goes here...
	DECLARE outError TINYINT DEFAULT 0;
	DECLARE outPkLiquidation INT DEFAULT 0;
	
	SET outError = ts_fn_verify_addLiquidation( InFkJournalDriver, InFkDriver, InOperation, InFkAccount );
	
	IF outError = 0 THEN
		
		INSERT INTO ts_liquidation ( operation,
																 observation,
																 amount,
																 amountCompany,
																 haveDebt,
		...
		SET outPkLiquidation = LAST_INSERT_ID();
		
		UPDATE ts_journal_driver SET fkLiquidation = outPkLiquidation,
																	liquidated = 1,
																	dateLiquidated = CURRENT_TIMESTAMP()
		WHERE pkJournalDriver = InFkJournalDriver AND fkDriver = InFkDriver;
...
#pago con tarjeta
IN `InCulquiTkn` varchar(30),
IN `InCulquiCharge` varchar(30),
IN `InCulquiCard` varchar(30),
...
BEGIN
	#Routine body goes here...
	DECLARE outError, outCountCredit INT DEFAULT 0;
	DECLARE outPkService, outServices BIGINT DEFAULT 0;
	DECLARE outAliasCategory, outCodeCategory VARCHAR(20);
	
	SET outError = ts_fn_verify_addService( InFkClient, InFkJournal, InFkRate, InRateService, InFkUser, InFkCouponUser, InDiscountType, InPaymentType);
...
BEGIN
	...
	DECLARE vCountService TINYINT DEFAULT 0;
	
	SET outError = ts_fn_verify_closeJournal( InPkJournal, InFkDriver );
	
	IF outError = 0 THEN
	
		SELECT countService INTO vCountService
		FROM ts_journal_driver
		WHERE pkJournalDriver = InPkJournal;
...
-- ----------------------------
-- Procedure structure for ts_sp_deleteAccountDriver
-- ----------------------------
DROP PROCEDURE IF EXISTS `ts_sp_deleteAccountDriver`;
delimiter ;;
CREATE PROCEDURE `ts_sp_deleteAccountDriver`(IN `InPkAccount` int,
IN `InStatus` tinyint,
IN `InFkDriver` int,
IN `InFkUser` int,
IN `InIpUser` varchar(20))
BEGIN
	...
	SET outError = ts_fn_verify_deleteAccountDriver( InPkAccount, InFkDriver );
	
	IF outError = 0 THEN
		
		IF InStatus = 0 THEN
			
			UPDATE ts_account_driver SET	statusRegister = 0,
																		fkUserDelete = InFkUser,
																		dateDelete = CURRENT_TIMESTAMP(),
																		ipDelete = InIpUser
			WHERE fkDriver = InFkDriver AND pkAccountDriver = InPkAccount;
		...
		ELSE
			...
			UPDATE ts_account_driver SET	statusRegister = 1,
																		fkUserUpdate = InFkUser,
																		dateUpdate = CURRENT_TIMESTAMP(),
																		ipUpdate = InIpUser
			WHERE fkDriver = InFkDriver AND pkAccountDriver = InPkAccount;
...
-- ----------------------------
-- Procedure structure for ts_sp_deleteLiquidation
-- ----------------------------
DROP PROCEDURE IF EXISTS `ts_sp_deleteLiquidation`;
delimiter ;;
CREATE PROCEDURE `ts_sp_deleteLiquidation`(IN `InPkLiquidation` bigint,
IN `InFkJournalDriver` bigint,
IN `InFkDriver` int,
IN `InStatus` tinyint,

-- datos opcionales solo cuando se restaura
IN `InOperation` varchar(15),
IN `InObservation` varchar(100),
IN `InAmount` float(5,2),
IN `InFkAccount` int,
...
BEGIN
	...
	SET outError = ts_fn_verify_deleteLiquidation( InPkLiquidation, InFkJournalDriver, InFkDriver );
	
	IF outError = 0 THEN
		
		IF InStatus = 0 THEN
			#eliminar liquidación
			UPDATE ts_liquidation SET statusRegister = 0,
																fkUserDelete = InFkUser,
																dateDelete = CURRENT_TIMESTAMP(),
																ipDelete  = InIpUser
			...
			UPDATE ts_journal_driver SET fkLiquidation = 0,
																	liquidated = 0,
																	dateLiquidated = NULL
			WHERE pkJournalDriver = InFkJournalDriver AND fkDriver = InFkDriver;
		...
		ELSE
			...
			UPDATE ts_liquidation SET statusRegister = 01,
															operation = InOperation,
															observation = InObservation,
															amount = InAmount,
															fkAccountDriver = InFkAccount,
															fkUserUpdate = InFkUser,
															dateUpdate = CURRENT_TIMESTAMP(),
															ipUpdate  = InIpUser
			...
			UPDATE ts_journal_driver SET fkLiquidation = InPkLiquidation,
																	liquidated = 1,
																	dateLiquidated = CURRENT_TIMESTAMP()
			WHERE pkJournalDriver = InFkJournalDriver AND fkDriver = InFkDriver;
...
-- ----------------------------
-- Procedure structure for ts_sp_getAccountDriver
-- ----------------------------
DROP PROCEDURE IF EXISTS `ts_sp_getAccountDriver`;
delimiter ;;
CREATE PROCEDURE `ts_sp_getAccountDriver`(IN `InFkDriver` int)
BEGIN
	#Routine body goes here...
	
	SELECT AC.pkAccountDriver,
					AC.ccAccount,
					AC.cciAccount,
					AC.fkBank,
					B.bankName,
					B.bankAlias,
					AC.dateRegister
	FROM ts_account_driver AC
	LEFT JOIN as_bank B ON B.pkBank = AC.fkBank
	WHERE AC.fkDriver = InFkDriver AND AC.statusRegister = 1
...
-- ----------------------------
-- Procedure structure for ts_sp_getAllBank
-- ----------------------------
DROP PROCEDURE IF EXISTS `ts_sp_getAllBank`;
delimiter ;;
CREATE PROCEDURE `ts_sp_getAllBank`()
BEGIN
	#Routine body goes here...
...
BEGIN
	...
	FROM ts_service S
	LEFT JOIN ts_offer_service OF ON OF.pkOfferService = S.fkOffer
...
-- ----------------------------
-- Procedure structure for ts_sp_getJournalDriverWeb
-- ----------------------------
DROP PROCEDURE IF EXISTS `ts_sp_getJournalDriverWeb`;
delimiter ;;
CREATE PROCEDURE `ts_sp_getJournalDriverWeb`(IN `InPage` int,
IN `InRowsForPage` tinyint,
IN `InQuery` varchar(40),
IN `InStatus` tinyint)
BEGIN
	#Routine body goes here...
	DECLARE outWhere, outFields VARCHAR(1000) DEFAULT '';
	
	SET @InStart = (InPage - 1) * InRowsForPage;
	SET @InLimit = InPage  * InRowsForPage;
	
	SET outWhere = CONCAT( ' WHERE JD.statusRegister = ' , InStatus, " AND JD.journalStatus = 0 " );
	
	IF InQuery != '' THEN
		SET outWhere = CONCAT( outWhere,' AND P.nameComplete LIKE ',"'%",InQuery,"%'");
	END IF;
	...
	SET @sql = CONCAT("SELECT JD.pkJournalDriver, 
														...
														U.pkUser	"
							,"FROM ts_journal_driver JD "							
							, " LEFT JOIN as_driver D ON D.pkDriver = JD.fkDriver "
							, " LEFT JOIN as_person P ON P.pkPerson = D.fkPerson "
							, " LEFT JOIN as_user U ON P.pkPerson = U.fkPerson "
							,outWhere
							," ORDER BY JD.dateRegister DESC LIMIT ?,? ;");
...
BEGIN
	...
	SET outWhere = CONCAT( ' WHERE JD.fkDriver = ',InFkDriver,' AND JD.statusRegister = 1 AND JD.journalStatus = ',InStatus );
	...
	SET @sql = CONCAT("SELECT JD.pkJournalDriver,
														...
														ts_fn_count_servicesJournal( JD.pkJournalDriver, ",InFkUser,", JD.codeJournal ) AS 'totalFn',
														
														CASE JD.modeJournal
															WHEN 'FORTODAY' THEN
																JD.rateJournal
															ELSE
																JD.rateJournal * countService
														END AS 'totalPay' ,
														
														ts_fn_debt_driverJournal( JD.pkJournalDriver, ", InFkDriver ," ) AS 'totalDebt',
														...
														JD.rateJournal,
														JD.modeJournal,
														IF( JD.dateEnd <= CURRENT_TIMESTAMP() , 1, 0) AS 'expired' "
				,"FROM ts_journal_driver JD  "
				,outWhere,
...
-- ----------------------------
-- Procedure structure for ts_sp_getServicesJournal
-- ----------------------------
DROP PROCEDURE IF EXISTS `ts_sp_getServicesJournal`;
delimiter ;;
CREATE PROCEDURE `ts_sp_getServicesJournal`(IN `InPage` tinyint,
...
BEGIN
	...
	SELECT S.pkService,
					...
					S.discount
	FROM ts_service S
	LEFT JOIN ts_offer_service O ON O.pkOfferService = S.fkOffer
	WHERE S.fkDriver = InPkUserDriver AND S.statusService = 3 AND O.fkJournalDriver = InFkJournal AND O.codeJournal = InCodeJournal
	ORDER BY S.dateRegister DESC
	LIMIT vStart, 5;
...
-- ----------------------------
-- Procedure structure for ts_sp_overallPageJournalDriverWeb
-- ----------------------------
DROP PROCEDURE IF EXISTS `ts_sp_overallPageJournalDriverWeb`;
delimiter ;;
CREATE PROCEDURE `ts_sp_overallPageJournalDriverWeb`(IN `InQuery` varchar(40),
IN `InStatus` tinyint)
BEGIN
	#Routine body goes here...
	DECLARE outWhere, outFields VARCHAR(1000) DEFAULT '';
...
-- ----------------------------
-- Procedure structure for ts_sp_overallPageServicesJournal
-- ----------------------------
DROP PROCEDURE IF EXISTS `ts_sp_overallPageServicesJournal`;
delimiter ;;
CREATE PROCEDURE `ts_sp_overallPageServicesJournal`(IN `InPkUserDriver` int,
IN `InFkJournal` bigint,
IN `InCodeJournal` varchar(10))
BEGIN
	#Routine body goes here...
...
-- ----------------------------
-- Procedure structure for ts_sp_updateAccountDriver
-- ----------------------------
DROP PROCEDURE IF EXISTS `ts_sp_updateAccountDriver`;
delimiter ;;
CREATE PROCEDURE `ts_sp_updateAccountDriver`(IN `InPkAccount` int,
...
BEGIN
	...
	SET outError = ts_fn_verify_updateAccountDriver( InPkAccount, InFkDriver, InFkUser, InAccountCC, InAccountCCI, InAliasBank );
	
	IF outError = 0 THEN
		
		UPDATE ts_account_driver SET	ccAccount = InAccountCC,
																	cciAccount = InAccountCCI,
																	bankName = InNameBank,
																	bankAlias = InAliasBank,
																	fkUserUpdate = InFkUser,
																	dateUpdate = CURRENT_TIMESTAMP(),
																	ipUpdate = InIpUser
		WHERE fkDriver = InFkDriver AND pkAccountDriver = InPkAccount;
...
-- ----------------------------
-- Procedure structure for ts_sp_updateChargeJournal
-- ----------------------------
DROP PROCEDURE IF EXISTS `ts_sp_updateChargeJournal`;
delimiter ;;
CREATE PROCEDURE `ts_sp_updateChargeJournal`(IN `InPkJournal` bigint,
IN `InChargeCulqui` varchar(30),
IN `InCardCulqui` varchar(30),
IN `InChargeAmount` int)
BEGIN
	#Routine body goes here...
	DECLARE outerror TINYINT DEFAULT 0;
	DECLARE outDebt FLOAT(5,2) DEFAULT 0;
	DECLARE vPkDriver INT DEFAULT 0;
	
	SET outError = ts_fn_verify_updateChargeJournal( InPkJournal );
	
	IF outError = 0 THEN
	
		SELECT fkDriver INTO vPkDriver
		FROM ts_journal_driver
		WHERE pkJournalDriver = InPkJournal;
		
		UPDATE ts_journal_driver SET chargeCulqui = InChargeCulqui,
																	cardCulqui = InCardCulqui,
		...
		SET outDebt = ts_fn_debt_driverJournal( InPkJournal, vPkDriver );
		
		IF outDebt > 0 THEN
			
			UPDATE ts_journal_driver SET paidOut = 1,
																		datePaid = CURRENT_TIMESTAMP(),
																		illPay = 0
			WHERE pkJournalDriver != InPkJournal AND fkDriver = vPkDriver AND paidOut = 0;
...
-- ----------------------------
-- Procedure structure for ts_sp_updateLiquidation
-- ----------------------------
DROP PROCEDURE IF EXISTS `ts_sp_updateLiquidation`;
delimiter ;;
CREATE PROCEDURE `ts_sp_updateLiquidation`(IN `InPkLiquidation` bigint,
IN `InFkJournalDriver` bigint,
IN `InFkDriver` int,
IN `InOperation` varchar(15),
IN `InObservation` varchar(100),
...
BEGIN
	...
	SET outError = ts_fn_verify_updateLiquidation( InPkLiquidation, InFkJournalDriver, InFkDriver, InOperation, InFkAccount );
	
	IF outError = 0 THEN
		
		UPDATE ts_liquidation SET operation = InOperation,
															observation = InObservation,
															amount = InAmount,
															amountCompany = InAmountCompany,
															haveDebt = InHaveDebt,
															fkAccountDriver = InFkAccount,
															fkUserUpdate = InFkUser,
															dateUpdate = CURRENT_TIMESTAMP(),
...
BEGIN
	...
	DECLARE InPaymentType CHAR(4) DEFAULT 'CASH';
	...
	IF outError = 0 THEN
		...
		ELSEIF InRunDestination = 1 AND InFinishDestination = 0 THEN
			...
			SELECT rateService, discountType, fkCouponUser, paymentType
			INTO InRateService, InDiscountType, InFkCouponUser, InPaymentType
			FROM ts_service
			WHERE pkService = InPkService;
...
BEGIN
  ...
  DECLARE cur1 CURSOR FOR 
	...
	FROM as_user U
	LEFT JOIN as_person P ON P.pkPerson = U.fkPerson
	WHERE  U.role IN ('CLIENT_ROLE', 'DRIVER_ROLE') AND codeReferal IS NULL;
  ...
  read_loop: LOOP FETCH cur1 INTO vPkUser, vName, vSurname;
    ...
    END IF;
		...
		UPDATE as_user SET codeReferal = as_fn_generateCode( vName, vSurname, vPkUser )
		WHERE pkUser = vPkUser;
